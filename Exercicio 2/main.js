...
function menu() {
  ...
  switch (escolha) {
    case 1:
      ...
      const duracao = +prompt("Digite a duração do filme em minutos:");
    ...
    case 2:
      if (filmes.length === 0) {
        ...
        const index = +prompt("Escolha o número do filme que você assistiu:") - 1;
        if (filmes[index]) {
    ...
    case 3:
      if (filmes.length === 0) {
        ...
        const index = +prompt("Escolha o número do filme que você quer avaliar:") - 1;
        if (filmes[index]) {
          const nota = +prompt("Digite sua avaliação (0 a 10):");
